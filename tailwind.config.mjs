  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        slideIn: 'slideIn 1.5s cubic-bezier(0.18, 0.9, 0.18, 0.9) both',
        fadeIn: 'fadeIn 0.5s ease-out both',
        fadeInUp: 'fadeInUp 0.8s cubic-bezier(0.25, 0.1, 0.25, 1) both',
        fadeInRight: 'fadeInRight 0.8s cubic-bezier(0.25, 0.1, 0.25, 1) both',
        fadeOut: 'fadeOut 1.5s ease-out both',
        carousel: 'carousel 14s cubic-bezier(0.77, 0, 0.18, 1) infinite',
        textReveal: 'textReveal 1s cubic-bezier(0.77, 0, 0.18, 1) both',
        imageCurtain: 'imageCurtain 1.8s cubic-bezier(0.77, 0, 0.18, 1) both',
        imageFadeIn: 'fadeIn 1.8s cubic-bezier(0.77, 0, 0.18, 1) both',
        ...
        expandWidth: 'expandWidth 1.5s cubic-bezier(0.18, 0.9, 0.18, 0.9) both',
        fadeInUpGlow: 'fadeInUpGlow 0.6s ease-out both, glowStart 0.3s ease-out 1.5s both, glowPulse 4s ease-in-out 2s infinite',
        ...
        circleExpand: 'circleExpand 1s cubic-bezier(0.77, 0, 0.18, 1) both',
      }
    }
  },
  plugins: [
